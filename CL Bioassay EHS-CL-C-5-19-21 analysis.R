...
CL.dat <- read.csv("Bioassays mortality - EHS-CL-C-6-7-21.csv")
...
group1 = CL.dat2[CL.dat2$Day==12 & CL.dat2$Treatment=="CL" & CL.dat2$Status=="Mycosed",]$Individuals
group2 = CL.dat2[CL.dat2$Day==12 & CL.dat2$Treatment=="No fungus" & CL.dat2$Status=="Mycosed",]$Individuals
